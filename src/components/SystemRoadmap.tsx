...
import { ChevronDown, ChevronRight, Layout, Monitor, Server, Database, GitBranch, Palette, Key, FileCode, MessageSquare, Calendar, Users, BarChart3, Settings, Zap, Layers, Smartphone, ExternalLink, Copy, CheckCircle2, AlertTriangle, Info, RefreshCw } from 'lucide-react';
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-lg p-6">
            <p className="text-slate-300 mb-4">
              Depois de remixar o projeto, execute estes passos essenciais para garantir que tudo funcione corretamente:
            </p>
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-white font-medium">Edge Functions — verify_jwt = false</p>
                  <p className="text-sm text-slate-400">
                    Configure as seguintes Edge Functions com <code className="text-amber-400">verify_jwt = false</code> no painel (não é no código, é na configuração de deploy):
                  </p>
                  <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2">
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">whatsapp-webhook</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">message-grouper</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">nina-orchestrator</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">whatsapp-sender</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">initialize-system</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">validate-setup</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">simulate-webhook</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">simulate-audio-webhook</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">test-whatsapp-message</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">test-elevenlabs-tts</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">generate-prompt</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">analyze-conversation</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">health-check</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">seed-appointments</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">trigger-nina-orchestrator</code>
                    <code className="text-xs text-amber-400 font-mono bg-slate-950 px-2 py-1 rounded">trigger-whatsapp-sender</code>
                  </div>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-white font-medium">Webhook no Meta for Developers</p>
                  <p className="text-sm text-slate-400">
                    Configure o webhook do WhatsApp Cloud API apontando para a URL da sua instância. Veja o tutorial "Configurar WhatsApp Business API" abaixo.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-white font-medium">ElevenLabs API Key (opcional)</p>
                  <p className="text-sm text-slate-400">
                    Se for usar áudio/voz, configure a chave da ElevenLabs na aba "APIs" das Configurações.
                  </p>
                </div>
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-lg p-6">
            <p className="text-slate-300 mb-4">
              Após remixar o projeto, execute estas configurações manuais para garantir o funcionamento completo:
            </p>
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-white font-bold mb-3 flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400" />
                  1. Edge Functions — verify_jwt = false
                </h4>
                <p className="text-sm text-slate-400 mb-2">
                  As seguintes Edge Functions precisam ter <code className="text-amber-400">verify_jwt = false</code> configurado manualmente no painel:
                </p>
                <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Configure a URL do webhook e o Verify Token na página do seu App no Meta for Developers.
                  A URL e o token estão disponíveis na aba "APIs" das Configurações.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Se desejar respostas em áudio, configure a API key da ElevenLabs na aba "APIs" das Configurações.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4">
            <p className="text-xs text-slate-400">
              <strong className="text-amber-400">⚠️ Nota:</strong> As migrações de Realtime, Triggers e RLS já foram aplicadas automaticamente. 
              O polling fallback no useConversations também já está configurado.
            </p>
          </div>
        </div>
      ),
